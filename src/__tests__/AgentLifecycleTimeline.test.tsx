...
describe("AgentLifecycleTimeline", () => {
  ...
  it("renders all 8 expected steps", () => {
    render(<AgentLifecycleTimeline agent={makeAgent({ lifecycleTimestamps: { spawned: "2024-01-01T10:00:00Z" } })} />);
    const expectedSteps = [
      "spawned",
      "working",
      "committed",
  ...
  it("marks spawned as completed and working as current for status=working", () => {
    render(<AgentLifecycleTimeline agent={makeAgent({ status: "working", lifecycleTimestamps: { spawned: "2024-01-01T10:00:00Z" } })} />);
